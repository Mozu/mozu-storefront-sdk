...
function getAdminUserAuthTicket(client) {
  return client.root().platform().adminuser().adminUser().createUserAuthTicket({ tenantId: client.getTenant() }, { body: client.context.developerAccount }).then(function(json) {
